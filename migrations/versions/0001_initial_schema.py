...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="mix_status"), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="stem_status"), nullable=False, server_default="pending"),
        sa.Column("error_message", sa.Text, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", UUID(as_uuid=False), primary_key=True),
        sa.Column("mix_id", UUID(as_uuid=False), sa.ForeignKey("mixes.id", ondelete="CASCADE"), nullable=False),
        sa.Column("visual_type", sa.Enum(name="visual_type"), nullable=False),
        sa.Column("aspect_ratio", sa.String(8), nullable=False, server_default="16:9"),
        sa.Column("gemini_prompt", sa.Text, nullable=False),
        sa.Column("file_path", sa.Text, nullable=True),
        sa.Column("status", sa.Enum(name="visual_status"), nullable=False, server_default="pending"),
        sa.Column("error_message", sa.Text, nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("upload_status", sa.Enum(name="short_upload_status"), nullable=False, server_default="pending"),
        sa.Column("error_message", sa.Text, nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("platform", sa.Enum(name="platform"), nullable=False),
        sa.Column("content_type", sa.Enum(name="content_type"), nullable=False),
        sa.Column("upload_status", sa.Enum(name="upload_status"), nullable=False, server_default="pending"),
